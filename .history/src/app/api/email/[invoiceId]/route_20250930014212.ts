import { currencyOption, TCurrencyKey } from "@/constants/currency";
...
import InvoiceTemplate from "@/components/templateInvoiceTemplate";
...
export async function POST(
  ...
  try {
    ...
    // Plain text fallback
    const textString = `
Hello ${session.user?.firstName ?? "Customer"},

Invoice No: ${invoiceData.invoice_no}
Due Date: ${format(invoiceData.due_date, "PPP")}
Total: ${currencyOption[invoiceData.currency as TCurrencyKey]} ${invoiceData.total}
