...
import InvoiceTemplate from "@/components/template/SendInvoiceEmail"; // ✅ new pure email template
...
export async function POST(
  ...
  try {
    ...
    const invoiceURL = `${process.env.NEXTAUTH_URL}/invoice/${userId}/${invoiceId}`;
